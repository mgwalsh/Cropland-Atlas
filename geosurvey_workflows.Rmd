...
Individual GeoSurvey contributions are acknowledged with a simple wordcloud, which highlights the proportion of the quadrats that were completed by each GeoSurveyor. This also essentially provides the survey signature for quality control purposes.
