# Stacked spatial predictions of Ethiopia GeoSurvey observations
...
# Data setup --------------------------------------------------------------
# Run this first: https://github.com/mgwalsh/Cropland-Atlas/blob/master/ET_geos_data_1718.R
# or run ...
# SourceURL <- "https://raw.githubusercontent.com/mgwalsh/blob/master/ET_geos_data_1718.R"
...
writeRaster(gspreds, filename="./Results/ET_BP_preds_1718.tif", datatype="FLT4S", options="INTERLEAVE=BAND", overwrite=T)
...
write.csv(gsout, "./Results/ET_BP_out.csv", row.names = F) ## ... change feature names here if needed
...
w ## plot widget 
saveWidget(w, 'ET_BP_1718.html', selfcontained = T) ## save html ... change feature names here
