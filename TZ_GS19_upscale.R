...
dir.create("TZ_GS18_100m", showWarnings = F)
setwd("./TZ_GS18_100m")
...
download("https://osf.io/xyp2r?raw=1", "TZ_building_preds_2019.zip", mode = "wb")
unzip("TZ_building_preds_2019.zip", overwrite = T)
