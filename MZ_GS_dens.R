# Stacked predictions of Mozambique 2019 GeoSurvey building densities 
...
writeRaster(gspreds, filename="./Results/MZ_bcount_2019.tif", datatype="FLT4S", options="INTERLEAVE=BAND", overwrite=T)## ... change feature names here
...
write.csv(gsout, "./Results/MZ_bcount_out.csv", row.names = F)
