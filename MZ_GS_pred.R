# Stacked predictions of Mozambique GeoSurvey observations
...
# Data setup --------------------------------------------------------------
# Run this first: https://github.com/mgwalsh/Cropland-Atlas/blob/master/MZ_GS19_data.R
...
fname <- paste("./Results/","MZ_", labs, "_preds_2019.tif", sep = "")
...
w ## plot widget 
saveWidget(w, 'MZ_BP_2019.html', selfcontained = T) ## save html ... change feature names here
